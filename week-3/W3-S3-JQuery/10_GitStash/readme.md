...
1. **Initialize the repository:**
   ...
   ```bash
   mkdir git-stash-exercise- creates a new empty folder
   cd git-stash-exercise- moved it into it
   git init-  Turns the folder into a Git repository. Before this, it's just a normal folder. After it, Git starts watching everything inside it.
   ```
